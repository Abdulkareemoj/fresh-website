...
export default function Header() {
    ...
    return (
        <header
            className={`top-0 z-40 mx-auto w-full flex-none bg-white transition-all duration-100 ease-in md:bg-white/90 md:backdrop-blur-sm dark:bg-slate-900 dark:md:bg-slate-800/90 dark:md:backdrop-blur-sm ${
        ...
        >
            <div className="mx-auto w-full max-w-full py-3 px-3 md:flex md:justify-between md:py-3.5 md:px-4">
                <div className="flex justify-between">
                    ...
                    >
                        <span className="ml-2 self-center whitespace-nowrap text-2xl font-bold text-slate-900 dark:text-white md:text-xl">
                            Welcome
                        </span>
                    </a>
                                ...
                                >
                                    {links && links.length
                                        ? (
                                            <>
                                                <button
                                                    className="flex items-center px-4 py-3 font-medium transition duration-150 ease-in-out hover:text-slate-900 dark:hover:text-slate-300"
                                                    onClick={() =>
                                                ...
                                                <ul
                                                    className={`${
                                                        isDropdownOpen[index]
                                                            ? "block"
                                                            : "md:hidden"
                                                    } rounded pl-4 font-medium drop-shadow-xl md:absolute md:min-w-[200px] md:bg-white/90 md:pl-0 md:backdrop-blur-md dark:md:bg-slate-800/90`}
                                                >
                                                    {links.map((
                                                        {
                                                            label: label2,
                                                        ...
                                                        >
                                                            <a
                                                                className="whitespace-no-wrap block py-2 px-5 first:rounded-t last:rounded-b md:hover:bg-slate-200 dark:md:hover:bg-slate-700"
